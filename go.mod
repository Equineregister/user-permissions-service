module github.com/Equineregister/user-permissions-service

go 1.24.1

require (
	github.com/Equineregister/data-dog-instrumentation v1.0.16
	github.com/Equineregister/slogger v1.0.0
...
require (
	...
	github.com/DataDog/datadog-lambda-go v1.19.0 // indirect
